...
<div class="container">
  <div class="row text-center flex-center position-ref padding-original">
    <div class="col-md-12">
      <p class="title">ギブテック</p>
      <p class="subtitle">未来へ繋ぐ、一歩を踏み出してみよう！</p>
    ...
    @guest
      <div class="pt-5">
        <form method='POST' action="{{ route('login') }}">
          @csrf
          <input id="email" type="hidden" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="test@example.com" required autofocus>
